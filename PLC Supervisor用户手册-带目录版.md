...
- [数据采集配置](#configuration-app)
- [数据监控](#monitoring-data)  
- [附录](#appendix)

![](images/2020-03-12-17-19-56.png)
...
<h3 id="thingsboard-reference-configuration">Thingsboard参考配置</h3>  

- [添加设备和资产](#adding-equipment-and-assets)
- [传输PLC数据到设备](#transfer-plc-data-to-the-device)
...
<h4 id="transfer-plc-data-to-the-device">传输PLC数据到设备</h4>  

...
<!-- code_chunk_output -->
  - [第一节 搭建MobiusPi开发环境](#第一节-搭建mobiuspi开发环境)
- [**第一章 MobiusPi Python开发快速入门**](#第一章-mobiuspi-python开发快速入门)
- [目录](#目录)
  - [第一节 搭建MobiusPi开发环境](#第一节-搭建mobiuspi开发环境)
    - [1. 准备硬件设备及其网络环境](#1-准备硬件设备及其网络环境)
      - [1.1 接通电源并使用网线连接PC](#11-接通电源并使用网线连接pc)
      - [1.2 设置LAN网络参数](#12-设置lan网络参数)
      - [1.3 设置WAN网络参数](#13-设置wan网络参数)
      - [1.4 更新软件版本](#14-更新软件版本)
      - [1.5 启用MobiusPi的调试模式](#15-启用mobiuspi的调试模式)
    ...
    - [3. 准备VS Code开发环境](#3-准备vs-code开发环境)
      ...
      - [3.3 配置工程模板](#33-配置工程模板)
        - [3.3.1 使用映翰通标准工程模板](#331-使用映翰通标准工程模板)
        - [3.3.2 自定义工程模板](#332-自定义工程模板)
